/**
 * Hybrid Sandbox - Milestone 4: Seamless Handoff
 *
...
import type { Sandbox, SandboxStats, ExecResult } from "@open-harness/sandbox";
import type { Dirent } from "fs";

/**
 * Types of operations that can be tracked for replay.
 */
...
export class HybridSandbox implements Sandbox {
  ...
  private get current(): Sandbox {
    return this.state === "vercel" && this.vercel ? this.vercel : this.justBash;
  }
