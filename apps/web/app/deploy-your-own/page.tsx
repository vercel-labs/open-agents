...
const DEPLOY_TEMPLATE_URL = (() => {
  const params = new URLSearchParams([
    ...
    [
      "envDescription",
      "Neon can provide POSTGRES_URL automatically. Generate JWE_SECRET and ENCRYPTION_KEY yourself, then add your WorkOS and GitHub App credentials for a full deployment.",
    ],
