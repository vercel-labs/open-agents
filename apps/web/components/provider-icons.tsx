...
function XAIIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="currentColor" d="M1 5.66 8.03 16h3.13L4.13 5.66zm3.13 5.74L1 16h3.13l1.56-2.3zM11.87 0l-5.4 7.95 1.56 2.3L15 0zm.57 4.92V16H15V1.15z"/>
    </svg>
  );
}
...
function MistralIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="#FFD800" d="M4.57 2.35H2.3V4.6h2.28zM13.71 2.35h-2.28V4.6h2.28z"/>
      <path fill="#FFAF00" d="M6.86 4.6H2.29v2.27h4.57zM13.71 4.6H9.14v2.27h4.57z"/>
      <path fill="#FF8205" d="M13.71 6.87H2.3v2.26H13.7z"/>
      <path fill="#FA500F" d="M4.57 9.13H2.3v2.26h2.28zM9.14 9.13H6.86v2.26h2.28zM13.71 9.13h-2.28v2.26h2.28z"/>
...
function PerplexityIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="#20808D" fillRule="evenodd" d="m2.87 0 4.56 4.2V0h.89v4.2L12.89 0v4.79h1.88v6.9H12.9v4.26l-4.58-4.02V16h-.89v-4l-4.55 4v-4.31H1v-6.9h1.87zm3.9 5.66H1.88v5.15h.99V9.2zm-3 3.92v4.47l3.66-3.23V6.25zm4.57 1.2V6.24l3.67 3.33V14zm4.56.03h.99V5.66H9.05l3.85 3.5zM12 4.8V2.02L9 4.79zm-5.23 0h-3V2.02z" clipRule="evenodd"/>
    </svg>
  );
}
...
function MoonshotIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="currentColor" d="M6.45 12.61q0 .9.16 1.7l4.16 1.2A7.97 7.97 0 0 1 .55 10.91zM6.97 9.15l-.04.14q-.2.71-.32 1.41l7.71 2.21q-.51.65-1.13 1.18L.38 10.42a8 8 0 0 1-.34-3.26zM8.45 5.96q-.45.66-.8 1.43l8.17 2.34a8 8 0 0 1-.44 1.38L.1 6.73a8 8 0 0 1 1.05-2.86zM11.63 3.27q-.95.32-1.84 1.12l5.99 1.72q.18.75.22 1.57L1.4 3.48A8 8 0 0 1 4 1.09zM10.2.31a8 8 0 0 1 4.56 3.4L4.56.78A8 8 0 0 1 10.2.31"/>
    </svg>
  );
}
...
function CohereIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="#39594D" fillRule="evenodd" d="M5.18 9.54a6 6 0 0 0 2.48-.52c1.39-.57 4.12-1.6 6.1-2.66 1.39-.75 1.98-1.73 1.98-3.05A3.3 3.3 0 0 0 12.44 0H4.76A4.76 4.76 0 0 0 0 4.76c0 2.62 2 4.78 5.18 4.78" clipRule="evenodd"/>
      <path fill="#D18EE2" fillRule="evenodd" d="M6.49 12.8c0-1.28.76-2.45 1.96-2.94l2.4-1A3.71 3.71 0 1 1 12.29 16H9.67a3.2 3.2 0 0 1-3.17-3.21" clipRule="evenodd"/>
      <path fill="#FF7759" d="M2.75 10.15A2.76 2.76 0 0 0 0 12.91v.36a2.75 2.75 0 0 0 5.5-.02v-.36a2.77 2.77 0 0 0-2.75-2.74"/>
    </svg>
  );
}
...
function MetaIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="#0081FB" d="M1.73 9.69c0 .6.13 1.08.3 1.36.24.37.58.53.93.53.45 0 .86-.11 1.66-1.2.63-.89 1.38-2.13 1.89-2.9l.85-1.31c.6-.92 1.28-1.93 2.07-2.62a3 3 0 0 1 2.04-.87c1.17 0 2.29.68 3.14 1.95A9 9 0 0 1 16 9.6c0 1.08-.21 1.87-.57 2.5a2.4 2.4 0 0 1-2.18 1.2v-1.72c.98 0 1.23-.9 1.23-1.93 0-1.47-.35-3.1-1.1-4.27-.54-.83-1.23-1.33-2-1.33-.82 0-1.49.62-2.23 1.73q-.59.9-1.27 2.13l-.5.89a23 23 0 0 1-1.78 2.88c-.89 1.18-1.64 1.63-2.64 1.63a2.6 2.6 0 0 1-2.4-1.29A4.7 4.7 0 0 1 0 9.62z"/>
      <path fill="url(#logo-meta__a)" d="M1.32 4.77c.8-1.22 1.93-2.08 3.25-2.08.76 0 1.51.23 2.3.87.86.7 1.78 1.86 2.93 3.77l.4.69c1 1.65 1.57 2.5 1.9 2.9.42.52.72.67 1.1.67.99 0 1.23-.9 1.23-1.93l1.53-.05c0 1.08-.22 1.87-.58 2.5a2.4 2.4 0 0 1-2.17 1.21 2.7 2.7 0 0 1-2.05-.81c-.53-.5-1.16-1.4-1.64-2.21L8.08 7.9C7.36 6.7 6.7 5.8 6.32 5.4c-.41-.44-.94-.97-1.78-.97-.68 0-1.26.48-1.75 1.21z"/>
      <path fill="url(#logo-meta__b)" d="M4.58 4.42c-.68 0-1.26.48-1.75 1.21a7.7 7.7 0 0 0-1.1 4.06c0 .6.13 1.08.3 1.36l-1.47.97A4.7 4.7 0 0 1 0 9.62c0-1.7.47-3.49 1.36-4.86.8-1.23 1.94-2.08 3.25-2.08z"/>
      <defs>
        <linearGradient id="logo-meta__a" x1="3.35" x2="14.367" y1="9.203" y2="9.759" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0064E1"/>
          <stop offset=".4" stopColor="#0064E1"/>
          <stop offset=".83" stopColor="#0073EE"/>
          <stop offset="1" stopColor="#0082FB"/>
        </linearGradient>
        <linearGradient id="logo-meta__b" x1="2.504" x2="2.504" y1="10.414" y2="6.352" gradientUnits="userSpaceOnUse">
...
function ZAIIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 16 16" fill="none" {...props}>
      <path fill="currentColor" d="M8.4 1.2 7.3 2.8a1 1 0 0 1-.78.4H.41v-2zM16 1.2 6.4 14.8H0L9.6 1.2zM7.6 14.8l1.12-1.6c.17-.25.47-.4.78-.4h6.1v2z"/>
    </svg>
  );
}
