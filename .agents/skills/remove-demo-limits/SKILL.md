...
## Required changes
1. Remove the guards that block session creation or chat messages for managed-template users.
...
4. Remove or update tests that assert the hosted caps or hosted-only auth gating.
