  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        />
        {isPreviewDeployment && (
          <div className="sticky top-0 z-50 flex items-center justify-center gap-2 bg-orange-400/8 backdrop-blur-sm px-4 py-1.5 text-center text-xs font-medium text-orange-500 dark:text-orange-400">
            <span>⚠️</span>
