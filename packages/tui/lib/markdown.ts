...
const MARKDOWN_THEME: ThemeTokenStyle[] = [
  ...
  { scope: ["function"], style: { foreground: "#dcdcaa" } },
  {
    ...
    style: { foreground: "#dcdcaa", bold: true },
  },
  ...
  { scope: ["attribute"], style: { foreground: "#9cdcfe" } },
  {
    ...
    style: { foreground: "#c586c0", bold: true },
  },
...
const markdownSyntaxStyle = SyntaxStyle.fromTheme(MARKDOWN_THEME);
const markdownTreeSitterClient = getTreeSitterClient();
